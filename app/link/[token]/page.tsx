  ...
  if (!target)
    return (
      <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 text-center">
        ...
        <p className="mt-2 text-slate-500">This upload link is invalid or has expired. Ask your accountant for a new one.</p>
      </main>
    );
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="text-xs font-medium uppercase tracking-wide text-indigo-600">Secure upload</div>
